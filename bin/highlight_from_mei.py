...
if __name__ == "__main__":
    ...
    for neume in neumes:
        ...
        rgb.draw_text((int(facs.ulx) - 20, int(facs.uly) - 20), note_string, RGBPixel(0,255,0), pixel_size=20, bold=True, halign="left")
        rgb.draw_text((int(facs.ulx) - 20, int(facs.uly) - 50), neume.name, RGBPixel(0,255,0), pixel_size=20, bold=True, halign="left")
